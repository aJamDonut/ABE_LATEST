...
//Note, loading the same file multiple times can cause game not to load

//TRACKS
_BLUEPRINTS.AUDIO.track01 = {
	file: "track01.mp3",
	vol: 0.02,
	loop: true
};

_BLUEPRINTS.AUDIO.ding = {
	file: "ding.mp3",
	vol: 0.5
};

_BLUEPRINTS.AUDIO.tack = {
	file: "tack.mp3",
	vol: 1
};

_BLUEPRINTS.AUDIO.dingLoop = {
	file: "hammer.mp3",
	vol: 1,
	loop: true
};

_BLUEPRINTS.AUDIO.windLoop = {
	file: "wind.mp3",
	vol: 0.01,
	loop: true
};

_BLUEPRINTS.AUDIO.beep = {
	file: "beep.mp3",
	vol: 0.5
};
_BLUEPRINTS.AUDIO.click = {
	file: "click.mp3",
	vol: 0.25
};

_BLUEPRINTS.AUDIO.paper = {
	file: "paper.mp3",
	vol: 0.25
};

_BLUEPRINTS.AUDIO.chunkshot = {
	file: "chunkshot.mp3",
	vol: 0.02
};
